...
const Sign_up = () => {
    ...
    return (
        <div className="address-div">
            <div>
                <h6 className="sideDrawer-header">Create your account</h6>
                <p className="sideDrawer-subheader">Enter your details below to create your account.</p>
            </div>
            <div>
                <form>
                ...
                <div className="sign-first inmt-15">
                    <h3 className="sign-first-text">Already have an account? <span className="get-started" onClick={()=>{onOpenSideBar('sign-in')}}><u>Log in</u></span> </h3>
                </div>
            </div>
        </div>
    )
